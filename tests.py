...
class ApplyPatchTestCase(unittest.TestCase):
    ...
    def test_apply_patch_from_string(self):
        ...
        self.assertIsNot(obj, res)
        self.assertIn("baz", res)
    ...
    def test_apply_patch_to_same_instance(self):
        obj = {"foo": "bar"}
        res = jsonpatch.apply_patch(
            obj, [{"op": "add", "path": "/baz", "value": "qux"}], in_place=True
        )
    ...
    def test_add_array_item(self):
        obj = {"foo": ["bar", "baz"]}
        res = jsonpatch.apply_patch(
            obj, [{"op": "add", "path": "/foo/1", "value": "qux"}]
        )
    ...
    def test_replace_object_key(self):
        obj = {"foo": "bar", "baz": "qux"}
        res = jsonpatch.apply_patch(
            obj, [{"op": "replace", "path": "/baz", "value": "boo"}]
        )
        self.assertEqual(res["baz"], "boo")

    def test_replace_whole_document(self):
        obj = {"foo": "bar"}
        res = jsonpatch.apply_patch(
            obj, [{"op": "replace", "path": "", "value": {"baz": "qux"}}]
        )
        self.assertEqual(res["baz"], "qux")
    ...
    def test_copy_object_key(self):
        obj = {"foo": {"bar": "baz", "waldo": "fred"}, "qux": {"corge": "grault"}}
        res = jsonpatch.apply_patch(
            obj, [{"op": "copy", "from": "/foo/waldo", "path": "/qux/thud"}]
        )
        self.assertEqual(
            res,
            {
                "qux": {"thud": "fred", "corge": "grault"},
    ...
    def test_copy_array_item(self):
        obj = {"foo": ["all", "grass", "cows", "eat"]}
        res = jsonpatch.apply_patch(
            obj, [{"op": "copy", "from": "/foo/1", "path": "/foo/3"}]
        )
    ...
    def test_copy_mutable(self):
        ...
        res = jsonpatch.apply_patch(
            obj, [{"op": "copy", "from": "/foo/0", "path": "/boo/0"}]
        )
        self.assertEqual(
            res, {"foo": [{"bar": 42}, {"baz": 3.14}], "boo": [{"bar": 42}]}
        )
        # modify original object
        res = jsonpatch.apply_patch(
            res, [{"op": "add", "path": "/foo/0/zoo", "value": 255}]
        )
    ...
    def test_unrecognized_element(self):
        obj = {"foo": "bar", "baz": "qux"}
        res = jsonpatch.apply_patch(
            obj, [{"op": "replace", "path": "/baz", "value": "boo", "foo": "ignore"}]
        )
        self.assertEqual(res["baz"], "boo")
...
class MakePatchTestCase(unittest.TestCase):
    ...
    def test_complex_object(self):
        src = {"data": [{"foo": 1}, {"bar": [1, 2, 3]}, {"baz": {"1": 1, "2": 2}}]}
        dst = {"data": [{"foo": [42]}, {"bar": []}, {"baz": {"boo": "oom!"}}]}
        patch = jsonpatch.make_patch(src, dst)
        res = patch.apply(src)
        self.assertEqual(res, dst)
    ...
    def test_json_patch(self):
        ...
        new = {"queue": {"teams_out": [{"id": 5, "reason": "If lose"}]}}
    ...
    def test_issue119(self):
        ...
        src = [
            {
                "foobar": {
                    "1": ["lettuce", "cabbage", "bok choy", "broccoli"],
                    "3": ["ibex"],
                    "2": ["apple"],
                    "5": [],
                    "4": ["gerenuk", "duiker"],
    ...
    def test_issue120(self):
        ...
        src = [
            {
                "foobar": {
                    "821b7213_b9e6_2b73_2e9c_cf1526314553": ["Open Work"],
        ...
        dst = [
            ...
            {
                "foobar": {
                    "b238d74d_dcf4_448c_9794_c13a2f7b3c0a": [],
...
class InvalidInputTests(unittest.TestCase):
    def test_missing_op(self):
        ...
        self.assertRaises(
            jsonpatch.JsonPatchException, jsonpatch.apply_patch, src, patch_obj
        )
...
class ConflictTests(unittest.TestCase):
    def test_remove_indexerror(self):
        ...
        self.assertRaises(
            jsonpatch.JsonPatchConflict, jsonpatch.apply_patch, src, patch_obj
        )
    ...
    def test_remove_keyerror(self):
        ...
        self.assertRaises(
            jsonpointer.JsonPointerException, jsonpatch.apply_patch, src, patch_obj
        )
    ...
    def test_create_with_pointer(self):
        patch = jsonpatch.JsonPatch(
            [
                ...
                {
                    "op": "add",
                    "path": jsonpointer.JsonPointer("/baz"),
                    "value": [1, 2, 3],
                },
                ...
                {
                    "op": "replace",
                    "path": jsonpointer.JsonPointer("/baz/0"),
                    "value": 42,
                },
                {"op": "remove", "path": jsonpointer.JsonPointer("/baz/1")},
                {
                    "op": "move",
                    "from": jsonpointer.JsonPointer("/foo"),
                    "path": jsonpointer.JsonPointer("/bar"),
                },
            ]
        )
        doc = {}
...
class UtilityMethodTests(unittest.TestCase):
    ...
    def test_replace_operation_structure(self):
        ...
        with self.assertRaises(jsonpatch.InvalidJsonPatch):
            jsonpatch.ReplaceOperation({"path": "/top/-", "value": "foo"}).apply(
                {"top": {"inner": "value"}}
            )

        with self.assertRaises(jsonpatch.JsonPatchConflict):
            jsonpatch.ReplaceOperation({"path": "/top/missing", "value": "foo"}).apply(
                {"top": {"inner": "value"}}
            )
...
class CustomJsonPointerTests(unittest.TestCase):
    ...
    def test_operations(self):
        operations = [
            (jsonpatch.AddOperation, {"op": "add", "path": "/foo", "value": [1, 2, 3]}),
            (
    ...
    def test_custom_operation(self):
        ...
        class JsonPatch(jsonpatch.JsonPatch):
            operations = MappingProxyType(
                dict(identity=IdentityOperation, **jsonpatch.JsonPatch.operations)
            )
...
if __name__ == "__main__":
    ...
    def get_suite():
        ...
        suite.addTest(test_loader.loadTestsFromTestCase(ApplyPatchTestCase))
        suite.addTest(test_loader.loadTestsFromTestCase(EqualityTestCase))
        suite.addTest(test_loader.loadTestsFromTestCase(MakePatchTestCase))
        suite.addTest(test_loader.loadTestsFromTestCase(ListTests))
        suite.addTest(test_loader.loadTestsFromTestCase(InvalidInputTests))
        suite.addTest(test_loader.loadTestsFromTestCase(ConflictTests))
        suite.addTest(test_loader.loadTestsFromTestCase(OptimizationTests))
        suite.addTest(test_loader.loadTestsFromTestCase(JsonPointerTests))
        suite.addTest(test_loader.loadTestsFromTestCase(JsonPatchCreationTest))
        suite.addTest(test_loader.loadTestsFromTestCase(UtilityMethodTests))
        suite.addTest(test_loader.loadTestsFromTestCase(CustomJsonPointerTests))
        suite.addTest(test_loader.loadTestsFromTestCase(CustomOperationTests))
        return suite
