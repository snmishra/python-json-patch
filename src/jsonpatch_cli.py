...
parser = argparse.ArgumentParser(description="Apply a JSON patch on a JSON file")
parser.add_argument("ORIGINAL", type=argparse.FileType("r"), help="Original file")
parser.add_argument(
    "PATCH",
...
parser.add_argument(
    "-b", "--backup", action="store_true", help="Back up ORIGINAL if modifying in-place"
)
parser.add_argument(
    "-i",
    "--in-place",
